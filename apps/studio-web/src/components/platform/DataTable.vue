...
type DragDropProviderProps = InstanceType<typeof DragDropProvider>["$props"]
type DragDropModifiers = NonNullable<DragDropProviderProps["modifiers"]>
...
const dragModifiers = [RestrictToVerticalAxis] as unknown as DragDropModifiers
</script>
  ...
  >
    ...
    >
      <div class="overflow-hidden rounded-lg border">
        <DragDropProvider :modifiers="dragModifiers">
          <Table>
