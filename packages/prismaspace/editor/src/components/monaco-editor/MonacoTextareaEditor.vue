...
const resolvedVerticalPadding = computed(() =>
  props.bare ? 12 : EDITOR_TEXTAREA_PADDING_TOP_PX + EDITOR_TEXTAREA_PADDING_BOTTOM_PX,
);
...
const resolvedOptions = computed<monaco.editor.IStandaloneEditorConstructionOptions>(() => ({
  ...
  cursorWidth: props.options?.cursorWidth ?? 1,
  scrollbar: {
  ...
  padding: {
    top: props.bare ? 6 : EDITOR_TEXTAREA_PADDING_TOP_PX,
    bottom: props.bare ? 6 : EDITOR_TEXTAREA_PADDING_BOTTOM_PX,
