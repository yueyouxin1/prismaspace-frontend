...
<template>
  <WorkbenchSurface
    :title="t('platform.workbench.scaffold.workflow.title')"
    :description="resourceDescription || t('platform.workbench.scaffold.workflow.description')"
    resource-type="workflow"
    :resource-name="resourceName"
    :updated-at="updatedAt"
    :workspace-instance-uuid="workspaceInstanceUuid"
    :latest-published-instance-uuid="latestPublishedInstanceUuid"
    :run-action="{ visible: runVisible, label: runLabel || t('platform.workbench.actions.run'), disabled: runDisabled, loading: running }"
