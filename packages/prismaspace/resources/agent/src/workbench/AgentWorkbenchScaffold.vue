...
import { WorkbenchSurface } from '@prismaspace/resources-core'
import type { WorkbenchSaveTrigger } from '@prismaspace/resources-core'
...
<template>
  <WorkbenchSurface
    :title="t('platform.workbench.scaffold.agent.title')"
    :description="resourceDescription || t('platform.workbench.scaffold.agent.description')"
    resource-type="agent"
    :resource-name="resourceName"
    :updated-at="updatedAt"
    :workspace-instance-uuid="workspaceInstanceUuid"
    :latest-published-instance-uuid="latestPublishedInstanceUuid"
    :run-action="{ visible: runVisible, label: runLabel || t('platform.workbench.header.actions.run'), disabled: runDisabled, loading: running }"
