...
<template>
  <WorkbenchSurface
    :title="t('platform.workbench.scaffold.knowledge.title')"
    :description="resourceDescription || t('platform.workbench.scaffold.knowledge.description')"
    ...
    :run-action="{ visible: runVisible, label: runLabel || t('platform.workbench.actions.search'), disabled: runDisabled, loading: running }"
